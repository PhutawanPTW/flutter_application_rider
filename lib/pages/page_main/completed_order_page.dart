...
import 'package:flutter_application_rider/pages/page_main/order_card.dart';
...
class _CompletedOrderPageState extends State<CompletedOrderPage> {
  ...
  Widget _buildSentOrderList() {
    return ListView(
      children: [
        buildOrderCard(context, 'assets/images/strawberry_shake.jpg', 'Strawberry Shake', 'Delivered'),
        buildOrderCard(context, 'assets/images/hong_thong.jpg', 'Hong Thong', 'Delivered'),
        buildOrderCard(context, 'assets/images/white_whisky.jpg', 'White Whisky', 'Delivered'),
      ],
    );
  }
